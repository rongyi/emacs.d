...
(use-package evil
  ...
  (evil-map normal "C-e" 'end-of-line)
  (evil-map insert "C-e" 'end-of-line)
  ...
  ;; like showing tmux buffer
  (evil-map insert "C-x =" 'helm-show-kill-ring)
  (evil-map emacs "C-x =" 'helm-show-kill-ring)
